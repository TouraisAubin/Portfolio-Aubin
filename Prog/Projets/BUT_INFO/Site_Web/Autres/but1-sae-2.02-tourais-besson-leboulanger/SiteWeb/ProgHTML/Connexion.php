...
<!-- Barre de Navigation -->
	<div class="w3-top">
		<div class="w3-bar w3-light-grey w3-border w3-large">
		    ...
		    <a class="w3-bar-item w3-indigo">Connexion</a>
				...
				<div class= "w3-sidebar w3-bar-block w3-animate-right" style="display:none;right:0;" id="rightMenu">
		  			  ...
		  			  <a href="Connexopn.php" class="w3-bar-item w3-button">Se connecter</a>
	...
	<div class="w3-panel w3-indigo w3-round-xlarge w3-padding-16 w3-center w3-margin w3-card-4">
		...
		<div class="w3-panel w3-white w3-round-xlarge w3-center w3-margin">

			<form method="post" action="../ProgPHP/ActionLoader.php">

<!-- Connexion -->
  <div class="w3-padding-64 w3-content w3-text-grey" id="contact">

    <h2 class="w3-text-indigo">CONNEXION</h2>
   ...
   <!-- <form action="../ProgPHP/action_page.php" target="_blank"> -->
      ...
      <p>
        <button class="w3-button w3-indigo w3-round-xlarge w3-padding-large w3-margin-top" type="submit"><i class="fa fa-paper-plane"></i> SE CONNECTER</button>
      </p>
...
<!-- Bouton si non connecté, direction vers Inscription -->
	 	<ul class="w3-ul">
			<li> <a href="Inscription.php"><button class="w3-button w3-indigo w3-round-xlarge">Inscrivez-vous</button></a> </li>
		</ul>
	</div>
